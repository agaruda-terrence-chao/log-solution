#!/bin/bash
# Build script for fluentd-aggregator with multi-architecture support

set -e

IMAGE_NAME="registry.internal.agaruda.io/agaruda/fluentd-aggregator"
TAG="${1:-latest}"
PLATFORM="${2:-linux/amd64}"

echo "Building fluentd-aggregator image..."
